...
event's full artwork image. `.github/workflows/digest.yml` runs it daily at 07:30 UTC
(UK morning), mid-game-day so players wake up to today's schedule. It needs no Comlink — rotation state comes from
